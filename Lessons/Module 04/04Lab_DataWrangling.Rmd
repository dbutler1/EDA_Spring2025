...
NTL.phys.data.Tuesday.year <- filter(NTL.phys.data.Tuesday, year4 > 1989 & year4 < 2000 )

summary(NTL.phys.data.Tuesday.year)

nrow(NTL.phys.data.1999)
nrow(NTL.phys.data.Tuesday.year)
```
