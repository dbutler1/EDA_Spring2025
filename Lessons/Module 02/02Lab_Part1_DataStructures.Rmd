...
#Logic - changing from true to false and vice versa
!vector3
...
matrix1[4,  ] #4, 9, 14, 19 - print full row
matrix1[ , 3] #print full column 
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) #need to comment out view when knitting
