...
---
## Task 4: Plots
Below this paragraph, but above the horizonal line (`---`), create two separate
...
```{r, echo = FALSE, fig.align ='left', fig.height=4,fig.cap="Title"}
...
plot_2018 <- ggplot(summary2018_Ozone) +
  ...
  labs(x="Month",y="Concentration Levels (ug/m^3)")
